  ...
  export default {
      ...
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.$axios.post('/product_group/editProductGroup',this.ruleForm)
              .then((response) =>{
            ...
            this.$axios.post('/common/upload').then((response)=>{
    ...
    created(){
      this.$nextTick(function () {
        //console.log(this.ruleForm.product_group_id)
        this.$axios.post('/product_group/getProductGroupDetail ',{'product_group_id':this.$route.query.data})
          .then((responses)=>{
            //console.log(responses.data.data)
            this.ruleForm = responses.data.data
          })
        this.$axios.post('/product_group/getParentProductGroupList',{'product_group_id':this.$route.query.data})
          .then((response)=>{
