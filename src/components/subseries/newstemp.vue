    ...
    <section class="newstemp-main">
      <el-form ref="form" :model="form" label-width="140px">
        ...
        <el-form-item label="默认邮费：">
          <el-input style="width: 100px"></el-input> <span> &nbsp;kg以内，</span> <el-input style="width: 80px"></el-input><span style="margin-left: 10px">元</span>
          <span>每增加&nbsp; </span><el-input style="width: 100px"></el-input><span>&nbsp; kg，增加&nbsp;</span><el-input style="width: 80px"></el-input><span>&nbsp;元</span>
        </el-form-item>
        <el-form-item label="满包邮：">
          <template slot-scope="scope">
            <span style="margin-right: 20px">自定义金额</span><el-switch v-model="form.delivery"></el-switch><span></span>
          </template>
        </el-form-item>
        <el-form-item label="个别区域及运费：">
          <div style="width: 700px;height: 400px;border: 1px solid">
